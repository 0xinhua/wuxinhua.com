...
function IconJike({
  ...
  return (
    <svg width="20" height="20" viewBox="0 0 38 37" fill="none" xmlns="http://www.w3.org/2000/svg" className={cn('size-5', className)}>
      ...
      <defs>
        <linearGradient id="paint0_linear_1615_6281" x1="19.3948" y1="6.80708" x2="19.3948" y2="26.6567" gradientUnits="userSpaceOnUse">
