...
可能是由于 2024 年春招，最近在博客后台发现的关于前端面试、八股文内容搜索量激增，于是补一篇手写代码文章，希望能给你在准备面试时提供一些解题思路。文章记录了我之前的前端面试中碰到的手写代码题，以及我的一些解题思路，大致给分了 4 类：基础题、`Polyfill`、业务相关题目、`leetcode` 题目。
