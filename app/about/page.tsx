        ...
        <div>
          <div className="mb-10 inline-block">
            <a href="https://321letter.substack.com/"><img className="rounded mb-5" src="https://assets.wuxinhua.com/blog/assets/newsletter/321-screenshot-20231128.png"></img></a>
              <p className="text-center mt-10">欢迎你订阅 Newsletter - <a className="text-blue-500  hover:underline hover:text-blue-600 underline-offset-4" target="_blank" href="https://321letter.substack.com/" title="Substack - 321来信">321来信</a></p>
